...
const SuggestionsSorting: React.FC<SuggestionsSortingProps> = ({
  ...
  return (
    <div className="relative">
      ...
      >
        Sort by :&nbsp;
        <span className="flex font-bold">{selectedOption}</span>
      ...
      {isOpen && (
        <ul className="text absolute top-[calc(100%+18px)] flex w-fit min-w-[255px] flex-col rounded-lg bg-white shadow-dropShadow">
          {sortingOptions &&
